...
def run_worflow(my_image,
  ...
  v = Visualizer(my_image[:, :, ::-1], custom_metadata, scale=1.2)
  out = v.draw_instance_predictions(filtered_predictions)
  result_image = out.get_image()[:, :, ::-1]  # RGB
  #cv2_imshow(out.get_image()[:, :, ::-1])
  ...
  #ax[1].set_title('Detected Image')
  if args['save']:
      plt.imsave(filename, result_image)
  else:
     #plt.show()
     pass
...
img_name = '../MarvinJS_Reactions/benz-13-oxazine_JS.png'
...
img_name2 = '../MarvinJS_Reactions/Englerin-A_JS.png'
