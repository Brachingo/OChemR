...
cfg.OUTPUT_DIR = "output_silva_custom"
cfg.DATASETS.TRAIN = ("my_dataset_train",)
cfg.DATASETS.TEST = ("my_dataset_val",)
cfg.DATALOADER.NUM_WORKERS = 4
cfg.MODEL.WEIGHTS = "output_silva_custom/model_final.pth" # model_zoo.get_checkpoint_url("COCO-Detection/faster_rcnn_X_101_32x8d_FPN_3x.yaml")  # Let training initialize from model zoo
...
evaluator = COCOEvaluator("my_dataset_val", cfg, False, output_dir="output_silva_custom/")
